...
public final class ErrorCodeConstant {
    ...
    public static final String IDEMPOTENCY_RESPONSE_DESERIALIZATION_FAILURE = "IDEMPOTENCY_RESPONSE_DESERIALIZATION_FAILURE";
    public static final String REQUEST_HASH_SERIALIZATION_FAILURE = "REQUEST_HASH_SERIALIZATION_FAILURE";
    public static final String REQUEST_HASH_GENERATION_FAILURE = "REQUEST_HASH_GENERATION_FAILURE";
}
